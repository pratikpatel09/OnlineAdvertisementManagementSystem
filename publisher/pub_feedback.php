                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="pub_feedback.php" class="waves-effect active"><i class="md-announcement"></i> <span> Feedback </span> </a>
                            </li>
                            <li>
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box" style="border-top:3px solid #448AFF; background-color: #CEE4FA;">
