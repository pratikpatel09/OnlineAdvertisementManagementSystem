            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="pub_index.php" class="logo"><span><span style="font-size: 25px; color: #5190F7;">A</span>d<span style="font-size: 25px; color: #5190F7;">W</span>ale</span></a>
                    </div>
                </div>
                            ...
                            <ul class="nav navbar-nav navbar-right pull-right">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="pub_profile.php"><i class="ti-user m-r-5"></i> Profile</a></li>
                                        <li><a href="pub_logout.php"><i class="ti-power-off m-r-5"></i> Logout</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
