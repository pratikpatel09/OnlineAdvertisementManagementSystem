...
<html>
    ...
    <body>
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="mynavbar">
                            ...
                            <ul class="nav navbar-nav pull-left">
                                ...
                                <li class="active"><a href="">How it Works</a><span class="underline_span"></li>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <h3 style="text-align:justify" class="text-info"><span class="glyphicon glyphicon-arrow-right"></span> Select the ad you want on your site</h3>
                    <p style="text-align:justify">More options mean more opportunities for revenue. Choose the right ad types and formats for your site. Ad types include Image banner, Animation Banner and Video Banner.</p>
                </div>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <h3 style="text-align:justify" class="text-info"><span class="glyphicon glyphicon-arrow-right"></span> Choose where you want ads to appear.</h3>
                    <p style="text-align:justify">Copy and paste a piece of code on your site where you want to show ads.</p>
                </div>
                <div class="col-sm-4"></div>
                <div class="col-sm-4"></div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <h3 style="text-align:justify" class="text-info"><span class="glyphicon glyphicon-arrow-right"></span> Leave the money stuff to us.</h3>
                    <p style="text-align:justify">We’ll handle the process of billing the advertisers and networks. When ads are seen or clicked, you’ll automatically earn money. You get paid once you’ve accrued a certain minimum amount.</p>
                </div>
                <div class="col-sm-4"></div>
                <div class="col-sm-4"></div>
            </div>
