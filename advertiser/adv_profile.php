...
<html>
    <head>
        ...
        <title>Advertiser Profile | AdWale</title>
    ...
    <?php
                                ...
                                if(isset($_POST['c_pwd']))
                                {
                                    ...
                                    if($flag==true)
                                    {
                                        $result=$mysqli->query("SELECT * FROM user_master WHERE u_email='".$_SESSION['ses_logid']."' and u_type='advertiser'");
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    $query = "SELECT u_firstname,u_lastname,u_email,u_password,u_contact_no FROM user_master WHERE u_email='".$_SESSION['ses_logid']."' and u_type='advertiser'";
