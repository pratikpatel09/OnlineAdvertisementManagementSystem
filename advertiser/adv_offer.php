...
<html>
    <head>
        ...
        <title>Advertiser Offers | AdWale</title>
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="adv_offer.php" class="waves-effect active"><i class="md-local-offer"></i> <span> Offers </span> </a>
                            </li>
                        </ul>
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <?php
                                $result=$mysqli->query("select * from offer_master where user_type='Advertiser' and curdate() >= start_date and curdate() <= end_date and status='active'");
