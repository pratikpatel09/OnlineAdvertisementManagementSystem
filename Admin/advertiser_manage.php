...
<html>
    <head>
        ...
        <title>Manage Advertiser - Admin | AdWale</title>
                        ...
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li class="active"><a href="advertiser_manage.php">Advertiser</a></li>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover mails m-0 table table-actions-bar">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                $rowcount1 = "";
                                                $query2 = "SELECT u_type from user_master where u_type='advertiser'";
                                                ...
                                                <?php
                                                $query = "select u_firstname,u_lastname,u_email,u_contact_no from user_master where u_type='advertiser'";
                                                $result = $mysqli->query($query);
                                                if ($result == true) {
                                ...
                                <div class="card-box">
                                    <div class="contact-card">
                                        ...
                                        <div class = "member-info">
                                            ...
                                            <h4 class = "m-t-0 m-b-5 header-title text-muted"><b>Total Advertisers</b></h4>
