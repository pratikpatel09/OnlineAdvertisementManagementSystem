...
<html>
    <head>
        ...
        <title>Admin password recover | AdWale</title>
    ...
    <body>
        ...
        if (isset($_POST['btnsendmail'])) {
            ...
            if ($flag == true) {
                ...
                $query = "select admin_email,admin_password from admin_master where admin_email='" . $adminemail . "'";
                $result = $mysqli->query($query);
                if ($result->num_rows == 1) {
                    $row = $result->fetch_assoc();
                    $to = $adminemail;
                    $subject = "Recover password : AdWale";
                    $txt = "<h3>Hello $adminemail (Admin), <br/><br/><br/> Your <font color='#5190F7'>A</font>d<font color='#5190F7'>W</font>ale account password is : <font color='#3c763d'>". $row['admin_password']."</font></h3>";
